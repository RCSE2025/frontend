...
const products: Product[] = [
  {
    ...
    description: "Погрузитесь в мир звука с нашими беспроводными наушниками премиум-класса. Оснащенные передовой технологией активного шумоподавления, эти наушники блокируют внешние шумы, позволяя вам наслаждаться кристально чистым звуком. Эргономичный дизайн обеспечивает комфорт при длительном использовании, а 30-часовой срок службы батареи гарантирует, что музыка не остановится в самый неподходящий момент. Быстрая зарядка за 15 минут обеспечивает 5 часов воспроизведения, а встроенные микрофоны с технологией шумоподавления обеспечивают четкие звонки даже в шумной обстановке.",
    price: 199.99,
    rating: 4.5,
    reviewCount: 128,
    images: [
    ...
    reviews: [
      {
        ...
        userName: "Алексей К.",
        rating: 5,
        comment: "Отличные наушники! Шумоподавление работает превосходно, звук чистый и насыщенный. Батарея держится даже дольше заявленного времени. Очень доволен покупкой!",
        date: "2025-02-15",
        helpful: 24
      },
      {
        ...
        userName: "Марина С.",
        rating: 4,
        comment: "Хорошее качество звука и шумоподавления. Комфортно сидят на ушах даже при длительном ношении. Единственный минус - немного тяжеловаты.",
        date: "2025-02-10",
        helpful: 15,
        images: [
      ...
      },
      {
        ...
        userName: "Дмитрий П.",
        rating: 3,
        comment: "Звук хороший, но шумоподавление среднее. В метро всё равно слышно окружающих. Батарея держится хорошо.",
        date: "2025-01-28",
        helpful: 8
      }
    ],
    ...
    reviews: [
      {
        ...
        userName: "Ирина М.",
        rating: 5,
        comment: "Отличные часы! Точно отслеживают пульс и сон, уведомления работают без задержек. Батарея держится около недели при активном использовании.",
        date: "2025-02-20",
        helpful: 18
      },
      {
        ...
        userName: "Сергей В.",
        rating: 3,
        comment: "Часы неплохие, но GPS иногда теряет сигнал. Функции мониторинга здоровья работают хорошо.",
        date: "2025-02-05",
        helpful: 10
      }
    ],
    ...
    reviews: [
      {
        ...
        userName: "Андрей Л.",
        rating: 5,
        comment: "Отличная колонка! Звук мощный и чистый, басы хорошие. Брал с собой на пляж - работает отлично, даже после попадания воды.",
        date: "2025-02-18",
        helpful: 22,
        images: [
      ...
      },
      {
        ...
        rating: 4,
        comment: "Хорошая колонка за свои деньги. Звук качественный, батарея держится долго. Единственный минус - немного тяжеловата для переноски.",
        date: "2025-02-10",
        helpful: 15
      }
    ],
    ...
    reviews: [
      {
        ...
        userName: "Максим Д.",
        rating: 5,
        comment: "Отличная зарядная станция! Заряжает быстро и без проблем. Очень удобно заряжать несколько устройств одновременно.",
        date: "2025-02-12",
        helpful: 19
      },
      {
        ...
        userName: "Ольга К.",
        rating: 4,
        comment: "Хорошая станция, но иногда нужно точно позиционировать устройства для начала зарядки. В целом довольна покупкой.",
        date: "2025-02-05",
        helpful: 12
      }
    ],
