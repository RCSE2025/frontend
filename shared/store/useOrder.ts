...
import { API } from '../api'
import { CreateOrderRequest, Order, OrderFilterOptions, OrderStatus, UpdateOrderStatusRequest } from '../api/order/types'
  ...
  cancelOrder: async (orderId: string) => {
    try {
      ...
      set((state) => ({
        ...
        currentOrder: state.currentOrder?.id === cancelledOrder.id 
          ? cancelledOrder 
          : state.currentOrder,
        loading: false
      }))
